...
CHANNELS = [
    ...
    # ── טורקיה 🇹🇷 (שוק יצוא + קנייה) ───────────────────────────
    "YagizSabuncuoglu",        # עיתונאי העברות #1 בטורקיה
    "FotoMacTR",               # FotoMaç — עיתון ספורט טורקי גדול
    "ASpor",                   # A Spor — ערוץ ספורט טורקי
    "Fanatik",                 # Fanatik — עיתון ספורט טורקי
    # ── אפריקה 🌍 (מקור גיוס מרכזי) ──────────────────────────────
    "NigerianFootball",        # כדורגל ניגרי
    "GHANAsoccernet",          # כדורגל גאנה
    "FootAfrique",             # כלל אפריקה
    # ── דרום אמריקה 🌎 ────────────────────────────────────────────
    "TNTSportsBR",             # TNT Sports ברזיל
    "TyCSports",               # TyC Sports ארגנטינה
]
